      ...
      <div className="mt-3 row">
        <div className="centerVert col-lg-2 offset-lg-6">
          <div className="positionTxt3">
            <h3 className="title3Project text-right"> Mining pool </h3>
            <p className="txt3Project text-right"> We develop mining pool<br/> from <b>scratch learning</b> on<br/> ourw knowledge of mining
            </p>
          </div>
        </div>
